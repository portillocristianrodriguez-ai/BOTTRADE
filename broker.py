...
# - ejecución de compra
#
# intenten proteger la misma posición
# simultáneamente.
# ============================================================
...
def _analizar_orden_proteccion(
    ...
    try:
        ...
        # OCO / BRACKET
        #
        # Si Alpaca identifica la orden como OCO o BRACKET,
        # sabemos que fue creada como estructura de protección
        # con SL + TP.
        # ----------------------------------------------------
...
def _esperar_cancelacion_protecciones(
    ...
    """
    Después de solicitar una cancelación, Alpaca puede mantener
    temporalmente la orden en estado OPEN / pending_cancel.

    Durante ese periodo las acciones siguen apareciendo como
    retenidas (held_for_orders).

    Esta función espera hasta que las órdenes de protección
    desaparezcan realmente de las órdenes abiertas.
    """
    ...
    try:
        ...
        for orden in protecciones:
            ...
            try:
                ...
                # Alpaca puede responder que la orden
                # ya está siendo cancelada.
...
def proteger_posicion(
    ...
    # LOCK
    #
    # Evita que recuperación, ejecución y loop de acciones
    # intenten modificar simultáneamente la protección.
    # --------------------------------------------------------
    ...
    try:
        ...
        # ----------------------------------------------------
        # SI HAY PROTECCIÓN PARCIAL:
        #
        # PRIMERO CANCELAR Y ESPERAR.
        #
        # NUNCA CREAR LA NUEVA OCO INMEDIATAMENTE.
        # ----------------------------------------------------
        ...
        #
        # La cantidad puede haber cambiado mientras
        # se cancelaba la orden.
        # ----------------------------------------------------
        ...
        # ----------------------------------------------------
        #
        # Alpaca permite utilizar OCO para añadir SL + TP
        # después de que la posición ya esté abierta.
        #
        # La orden OCO es una orden SELL de salida.
        # ----------------------------------------------------
        ...
        try:
            ...
            # ------------------------------------------------
            # SI ALPACA INDICA QUE LAS ACCIONES ESTÁN
            # RETENIDAS, NO SE DEBE SEGUIR CREANDO ÓRDENES.
            # ------------------------------------------------
