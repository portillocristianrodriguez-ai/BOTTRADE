...
<div class="grid section">
<div class="card wide7"><div class="sectionhead"><h2>POSICIONES Y RESULTADO ACTUAL</h2><span id="possummary" class="muted">—</span></div><div class="notice">Resultado estimado = cantidad × diferencia entre precio actual y compra media (signo inverso en cortos), antes de comisiones. Residuos: posiciones de menos de $0.01; siguen incluidos en el total. Verde = ganancia, rojo = pérdida, gris = cero o sin dato.</div><div id="positions" class="table"><div class="empty">Cargando…</div></div></div>
