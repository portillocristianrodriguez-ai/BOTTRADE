...
CRYPTO_ASSUMED_TAKER_FEE_BPS = _float("CRYPTO_ASSUMED_TAKER_FEE_BPS", 25.0)
CRYPTO_ASSUMED_EXIT_IMPACT_PCT = _float("CRYPTO_ASSUMED_EXIT_IMPACT_PCT", 0.10)
CRYPTO_MIN_NET_REWARD_RISK = _float("CRYPTO_MIN_NET_REWARD_RISK", 1.0)
