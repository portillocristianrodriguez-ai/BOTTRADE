...
class AIAnalystRuntime:
    ...
    def analyze(self,trades,equity=(),positions=()):
        ...
        import config
        current_config={"RISK_PER_TRADE_PCT":config.RISK_PER_TRADE_PCT,"STOP_LOSS_PCT":config.STOP_LOSS_PCT,"TAKE_PROFIT_PCT":config.TAKE_PROFIT_PCT,"TRAILING_STOP_PCT":config.TRAILING_STOP_PCT}
